...
urlpatterns = [
    ...
    path("home/space_mission/fire_astro", views.fire_astro, name='fire_astro'),
    path("homw/space_mission/assign_training", views.assign_training, name='assign_training'),
    path("home/space_mission/drop_training", views.drop_training, name='drop_training'),
